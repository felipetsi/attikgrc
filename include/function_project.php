...
function showListTaskProjet($ID_RELATED_ITEM,$SOURCE,$RESP_TYPE)
{
	if(!isset($_SESSION['user_id'])||(!isset($_SESSION['INSTANCE_ID']))){
		...
		require($_SESSION['LP']."include/variable.php");
		
		require($_SESSION['LP']."include/lang/".$_SESSION['lang_default']."/general.php");
