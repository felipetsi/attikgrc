...
$THIS_PAGE = "nonconformity.php";
$_SESSION['THIS_PAGE'] = $THIS_PAGE;
$DESTINATION_PAGE = "nonconformity_run.php";
// This session variable is used in box_task with 4 character
$_SESSION['PAGE_FROM'] = "nonconformity";
...
if(!isset($_SESSION['user_id'])||(!isset($_SESSION['INSTANCE_ID']))){
	...
	$PERMITIONS_NAME_2 = "read_own_nonconformity@";
	...
	if(!empty($ID_ITEM_SELECTED)){
		...
		$SQL .= "i.creation_date, i.execution_date, i.status ";
		$SQL .= "FROM tnonconformity i ";
	...
	<html lang="en">
		...
		<body class="fixed-nav sticky-footer bg-dark" id="page-top">
				...
				<div class="container-fluid">
					...
					<div class="mb-0 mt-4"></div>
						...
						<div class="card-header">
							<div class="card mb-3">
								<label class="control-label"><center><i><u><?php echo $LANG_NONCONFORMITY;?></u></i></center></label>
								<div class="row">
									<div class="col-md-12">
								...
								<div id= "editPanel" class="<?php if(isset($_SESSION['NONC_NAME'])){echo 'collapse_in';}else{echo 'collapse';}?>">
										...
										<form action="<?php echo $DESTINATION_PAGE;?>" method="post" name="main_form" id="main_form"  autocomplete="off">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="row">
														<div class="col-md">
															...
															<input class="form-control input-sm" type="text" id="nonc_name" name="nonc_name" 
																   placeholder="<?php echo $LANG_NAME;?>" 
																   value ="<?php if(!empty($_SESSION['NONC_NAME'])){ echo $_SESSION['NONC_NAME'];}
																	elseif(isset($ARRAYSELECTION)){ echo $ARRAYSELECTION['name'];} ?>" <?php echo ($CRET_CONT_INP); ?> onkeydown="javascript:submitenter(event.keyCode);" />
														</div>
													</div>
													<div class="row">
														<div class="col-md">
															<label class="control-label"><?php echo $LANG_DETAIL;?>:</label>
															<textarea class="form-control input-sm" rows="5" id="nonc_detail" name="nonc_detail" 
																	  placeholder="<?php echo $LANG_DESCRIPTION;?>" <?php echo ($CRET_CONT_INP);?>><?php if(!empty($_SESSION['NONC_DETAIL'])){ echo $_SESSION['NONC_DETAIL'];} elseif(isset($ARRAYSELECTION)){echo $ARRAYSELECTION['detail'];} ?></textarea>
														</div>
													</div>
													<div class="row">
														<div class="col-md">
															<label class="control-label"><?php echo $LANG_RESPONSIBLE;?>:</label>
															<select class="form-control" id="nonc_responsible" name="nonc_responsible" 
																...
																if(!empty($_SESSION['NONC_RESPONSIBLE'])){ $PARAMETER_SEL = $_SESSION['NONC_RESPONSIBLE'];}
												...
												<?php
													...
													<div class="row">
														<div class="col-md">
															<label class="control-label"><u>'.$LANG_NONCONFORMITY_NUM.':</u></label>
															...
															<div class="collapse box_show_task_side_right" id="show_intial_response">
																...
																<div class="row">
																	<div class="col-md-4">';
																		...
																		onclick="javascript: addTaskRelated('.$ID_ITEM_SELECTED.',\'nonc\',\'i\');">
													...
													<script>
														showListTaskRelated('.$ID_ITEM_SELECTED.',\'nonc\',\'i\');
													</script>
													<div class="row">
														<div class="col-md ">
															<div class="col-md">
															...
															<div class="collapse box_show_task_side_right" id="show_solution">
																...
																<div class="row">
																	<div class="col-md-4">';
																		...
																		<button type="button" class="btn btn-default btn-block" data-toggle="tooltip" 
																		data-placement="top" title="'.$LANG_ADD.'"
																		onclick="javascript: addTaskRelated('.$ID_ITEM_SELECTED.',\'nonc\',\'s\');">
																		<i class="fa fa-plus"></i></button>';} echo '
																	</div>
																</div>
															</div>
													...
													<script>
														showListTaskRelated('.$ID_ITEM_SELECTED.',\'nonc\',\'s\');
													</script>
															...
															<div class="collapse box_show_task_side_right" id="show_controls">
																...
																<div class="row">
																	<div class="col-md-4">
																		<button type="button" class="btn btn-default btn-block" data-toggle="tooltip" 
																		data-placement="top" title="'.$LANG_ADD.'"
																		onclick="javascript: addControlRelated('.$ID_ITEM_SELECTED.',\'nonc\');">
													...
													<script>
														showListControlRelationship('.$ID_ITEM_SELECTED.',\'nonc\');
													</script>
													...
													<div class="row">
														<div class="col-md">
															<div class="col-md">
																<button type="button" class="btn btn  btn-block" data-toggle="collapse" 
																	data-target="#show_process">
																<i class="fa fa-circle-o-notch"></i> '.$LANG_PROCESS.'</button>
															</div>
														
															<div class="collapse box_show_task_side_right" id="show_process">
																...
																<div class="row">
																	<div class="col-md-4">
																		<button type="button" class="btn btn-default btn-block" data-toggle="tooltip" 
																		data-placement="top" title="'.$LANG_ADD.'"
																		onclick="javascript: addProcessRelated('.$ID_ITEM_SELECTED.',\'nonc\');">
																		<i class="fa fa-plus"></i></button>
																	</div>
																</div>
															</div>
													...
													<script>
														showListProcessRelationship('.$ID_ITEM_SELECTED.',\'nonc\');
													</script>
													...
													<script>
														showFileRelationship('.$ID_ITEM_SELECTED.',\'nonc\');
													</script>
													';
													}
													?>
								...
								<form action="<?php if($_SESSION['STATUS_MULT_SEL'] == 0){ echo $THIS_PAGE;} else {echo $DESTINATION_PAGE;}?>" 
									...
									<table class="table table-bordered" width="100%" id="dataTable" name="dataTable" cellspacing="0">
										...
										if((strpos($_SESSION['user_permission'],$PERMITIONS_NAME_2) === false) &&
											...
											$SQL .= "FROM tnonconformity i WHERE i.id_instance = ".$_SESSION['INSTANCE_ID']." $COMMPL_CONTROL";
											...
											<?php } else {
													do{
														$SQL = "SELECT COUNT(id_task)  AS count FROM tanonconformity_response_task WHERE id_nonconformity = ".$ARRAY['id'];
			...
			<div class="modal fade" id="modalRelated" tabindex="-1" role="dialog" aria-labelledby="control_boxLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
